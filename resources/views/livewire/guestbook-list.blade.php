        ...
        <div class="splide__track">
            <div class="splide__list">
                @foreach ($guestbooks as $guestbook)
                    <div
                        class="flex flex-col items-stretch justify-between w-full max-w-sm gap-2 px-5 py-3 mx-auto text-center bg-white rounded-lg splide__slide">
                        ...
                        <div class="relative">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-gray-500">{{ count($guestbook->reactions) }}
